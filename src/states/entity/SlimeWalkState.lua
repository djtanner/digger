...
SlimeWalkState = Class{__includes = EntityWalkState}

function SlimeWalkState:init(entity, level)
    self.entity = entity
...
function SlimeWalkState:update(dt)
...
function SlimeWalkState:processAI(params, dt)
...
function SlimeWalkState:render()
